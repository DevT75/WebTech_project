...
const ProfileModal = () => {
  ...
  const handleRename = async() => {
    ...
    try {
      ...
      const { data } = await axios.put("//13.127.80.208:5000/api/chat/rename",{
  ...
  const handleAddUser = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put("//13.127.80.208:5000/api/chat/groupadd",{
        chatId: selectedChat._id,
        userId: user1._id,
      },config);
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put("//13.127.80.208:5000/api/chat/groupremove",{
        chatId: selectedChat._id,
        userId: user1._id,
      },config);
