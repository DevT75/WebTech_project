...
const ProfileModal = () => {
  ...
  const handleRename = async() => {
    ...
    try {
      ...
      const { data } = await axios.put("https://webtech-api-r6c3dizosq-de.a.run.app/api/chat/rename",{
  ...
  const handleAddUser = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put("https://webtech-api-r6c3dizosq-de.a.run.app/api/chat/groupadd",{
        chatId: selectedChat._id,
        userId: user1._id,
      },config);
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put("https://webtech-api-r6c3dizosq-de.a.run.app/api/chat/groupremove",{
        chatId: selectedChat._id,
        userId: user1._id,
      },config);
